...
<section>
    <div class="my-24">
        <div class="w-full mx-auto">
            <div class="relative flex justify-between px-3 md:px-8">
                <p class="uppercase"><?php the_field('clients_title'); ?></p>
                <svg width="62" height="30" viewBox="0 0 62 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M54.1348 26.7231C57.9275 26.7231 61.002 23.6012 61.002 19.7502C61.002 15.8992 57.9275 12.7773 54.1348 12.7773C50.3421 12.7773 47.2676 15.8992 47.2676 19.7502C47.2676 23.6012 50.3421 26.7231 54.1348 26.7231Z" fill="<?php the_field('clients_icon_color'); ?>" />
                    ...
                    <path d="M39.6206 4.93053L29.9106 14.7899C27.2287 17.513 27.2285 21.9277 29.9101 24.6506C32.5917 27.3734 36.9396 27.3732 39.6214 24.6501L49.3315 14.7908C52.0133 12.0677 52.0135 7.65292 49.3319 4.93009C46.6503 2.20726 42.3024 2.20746 39.6206 4.93053Z" fill="<?php the_field('clients_icon_color'); ?>" />
                </svg>
            </div>
    ...
    <?php if (isset($property["clients_slider_bottom"])): ?>
