    ...
    <div class="max-w-screen-xl mx-auto">
        ...
        <div class="clientSliderContainer mt-10">
            <div class="swiper clientSwiper">
                ...
                <div class="swiper-button-next client-button-next" 
                    ...
                    data-hover="<?= get_template_directory_uri() . '/assets/images/next-hover.svg'; ?>"></div>
                <div class="swiper-button-prev client-button-prev" 
                    ...
                    data-hover="<?= get_template_directory_uri() . '/assets/images/prev-hover.svg'; ?>"></div>
            </div>
        </div>
    </div>
</section>
