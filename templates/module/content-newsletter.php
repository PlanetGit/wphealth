...
<section>
    <div class="relative">
        <div class="py-20 px-4 <?= (isset($args['newsletter_owner']) && $args['newsletter_owner'] === 'format') ? "bg-purpleTint" : "bg-lightBlueTint"; ?>">
            <div class="w-full mx-auto md:flex items-center ">
                <div class="max-w-sm">
                    <?php if (isset($args['newsletter_owner']) && $args['newsletter_owner'] === 'format') : ?>
                        <svg width="62" height="30" viewBox="0 0 62 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M54.1348 26.723C57.9275 26.723 61.002 23.6011 61.002 19.7501C61.002 15.8991 57.9275 12.7772 54.1348 12.7772C50.3421 12.7772 47.2676 15.8991 47.2676 19.7501C47.2676 23.6011 50.3421 26.723 54.1348 26.723Z" fill="#973280" />
                ...
                <div class="md:ml-40 w-full">
                    ...
                    <form action="#">
                        <div class="md:flex justify-between border-b border-black">
                            ...
                            <input class="rounded-full border border-black px-6 uppercase mb-4 bg-white" type="submit" value="Submit">
                        </div>
                    </form>
                </div>
            </div>
