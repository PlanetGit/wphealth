...
<section class="clear-both">
    <div class="w-full mx-auto">
        <div class="md:flex">
            <div>
                <img src="<?php the_field('brochure_image'); ?>" alt="Brochure">
            </div>
            <div class="relative px-3 py-10 md:px-32 md:pt-20" style="background: <?php the_field('brochure_background_color'); ?>;">
                <span>
                ...
                <button class="px-10 py-1 mt-8 rounded-full border border-black uppercase hover:text-white hover:bg-black">Download</button>
            </div>
        </div>
    </div>
</section>