...
<section class="mt-28 relative">
    ...
    <div class="py-20 px-4 bg-lightBlueTint">
            ...
            <div class="md:ml-40 w-full">
                ...
                <form action="#">
                    <div class="md:flex justify-between border-b border-black">
                        <input type="email" name="newsletter_email" id="newsletter_email" class="bg-lightBlueTint outline-none" placeholder="Email Address">
    ...
    <div class="absolute bg-htcBlue-light w-11/12 h-[25px] z-10 -bottom-3"></div>
</section>