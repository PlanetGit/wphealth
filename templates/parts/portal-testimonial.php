...
<section>
    <div class="relative">
        <div class="py-28 bg-turquoiseTint">
            <div class="w-2/3 float-right pr-8">
                <div class="flex justify-between border-b border-black">
                    <span class="relative bottom-3">
                        <svg width="62" height="30" viewBox="0 0 62 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M54.1353 26.7231C57.928 26.7231 61.0025 23.6012 61.0025 19.7502C61.0025 15.8992 57.928 12.7773 54.1353 12.7773C50.3426 12.7773 47.2681 15.8992 47.2681 19.7502C47.2681 23.6012 50.3426 26.7231 54.1353 26.7231Z" fill="#01C9B7" />
                    ...
                    <p class="uppercase"><?= the_field('testimonial_title'); ?></p>
                </div>
                <p class="htcBodyFont mt-4"><?= the_field('testimonial_content'); ?></p>
                <p class="uppercase text-htcTurquoise mt-6"><?= the_field('testimonial_name'); ?></p>
            </div>
