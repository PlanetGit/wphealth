        ...
        <div class="relative flex justify-between px-3 md:px-8">
            ...
            <span class="mb-2">
                <svg width="62" height="31" viewBox="0 0 62 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M54.1353 27.3825C57.928 27.3825 61.0025 24.2606 61.0025 20.4096C61.0025 16.5586 57.928 13.4368 54.1353 13.4368C50.3426 13.4368 47.2681 16.5586 47.2681 20.4096C47.2681 24.2606 50.3426 27.3825 54.1353 27.3825Z" fill="#04449D" />
                    ...
                    <path d="M39.6206 5.59008L29.9106 15.4494C27.2287 18.1725 27.2285 22.5873 29.9101 25.3101C32.5917 28.033 36.9396 28.0328 39.6214 25.3097L49.3315 15.4503C52.0133 12.7272 52.0135 8.31247 49.3319 5.58964C46.6503 2.86681 42.3024 2.867 39.6206 5.59008Z" fill="#04449D" />
                </svg>
            </span>
        </div>
